...
class file_sink : public sink<false, BufferLimits, ThreadingPolicy>,
...
template <typename BufferLimits, typename FlushPolicy, typename ThreadingPolicy>
file_sink<BufferLimits, FlushPolicy, ThreadingPolicy>::file_sink(
    std::string_view path)
    : details::stream_writer<FlushPolicy>(path) {}

template <typename BufferLimits, typename FlushPolicy, typename ThreadingPolicy>
void file_sink<BufferLimits, FlushPolicy, ThreadingPolicy>::sink_it(
