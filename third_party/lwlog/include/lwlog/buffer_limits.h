...
namespace lwlog {
template <std::size_t Limit> struct pattern_limit {
    static constexpr std::size_t Value{Limit};
};
template <std::size_t Limit> struct message_limit {
    static constexpr std::size_t Value{Limit};
};
template <std::size_t Limit> struct argument_limit {
    static constexpr std::size_t Value{Limit};
};
template <std::size_t Limit> struct arg_count_limit {
    static constexpr std::size_t Value{Limit};
};
template <std::size_t Limit> struct padding_limit {
    static constexpr std::size_t Value{Limit};
};
template <std::size_t Limit> struct conv_limit {
    static constexpr std::size_t Value{Limit};
};
...
struct memory_buffer_limits {
    static_assert(
        std::is_same_v<PatternLimit, pattern_limit<PatternLimit::Value>>,
        "PatternLimit must be of type pattern_limit.");
    static_assert(
        std::is_same_v<MessageLimit, message_limit<MessageLimit::Value>>,
        "MessageLimit must be of type message_limit.");
    static_assert(
        std::is_same_v<ArgumentLimit, argument_limit<ArgumentLimit::Value>>,
        "ArgumentLimit must be of type argument_limit.");
    static_assert(
        std::is_same_v<ArgCountLimit, arg_count_limit<ArgCountLimit::Value>>,
        "ArgCountLimit must be of type arg_count_limit.");
    static_assert(
        std::is_same_v<PaddingLimit, padding_limit<PaddingLimit::Value>>,
...
using default_memory_buffer_limits =
    memory_buffer_limits<default_pattern_limit, default_message_limit,
                         default_argument_limit, default_arg_count_limit,
                         default_padding_limit, default_conv_limit>;
} // namespace lwlog
